...
class Testsrp
{
    ...
    public function run()
    {
        ...
        //解包
        $data     = [0xd0, 0x65, 0xda, 0xf1, 0x0c, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02];
        $packdata = Worldpacket::decrypter($data, $sessionkey);
        var_dump($packdata);

        $data     = [];
        $packdata = Worldpacket::decrypter($data, $sessionkey);
        var_dump($packdata);

        $data     = [0x53, 0x47, 0xa2, 0x9f, 0x57, 0x4a, 0x00, 0x00];
        $packdata = Worldpacket::decrypter($data, $sessionkey);
        var_dump($packdata);

        $data     = [0xc1, 0xd7, 0x57, 0x0d, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00];
        $packdata = Worldpacket::decrypter($data, $sessionkey);
        var_dump($packdata);
    }
}
